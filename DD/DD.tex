...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/sub_manager.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/rep_hist.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/prof_manager.png}
		\caption{As said above, the same happens for this module and the DBMS}
\end{figure}
\subsubsection{Authority Side Integration}
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/data_access.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/auth_manager.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/viol_solving.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/sugg_req.png}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{../assets/images/data_share.png}
