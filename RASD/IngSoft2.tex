...
\subsubsection{User Registration}
	\begin{figure}[H]
				\centering
				\includegraphics[width=1\linewidth]{assets/sequence_diagrams/exports/registration_private_subject.pdf}
				\label{fig:registration_sequence}
			\end{figure}
\subsubsection{User Login}
\begin{figure}[H]
				\centering
				\includegraphics[width=1\linewidth]{assets/sequence_diagrams/exports/login_private_subject.pdf}
				\label{fig:registration_sequence}
			\end{figure}
\subsubsection{Authority Login}
\begin{figure}[H]
				\centering
				\includegraphics[width=1\linewidth]{assets/sequence_diagrams/exports/login_public_subject.pdf}
				\label{fig:registration_sequence}
			\end{figure}
\subsubsection{Violation Reporting}
\begin{figure}[H]
				\centering
				\includegraphics[width=1\linewidth]{assets/sequence_diagrams/exports/workflow_private_subject.pdf}
				\label{fig:registration_sequence}
			\end{figure}
\subsubsection{Violation Solving}
\begin{figure}[H]
				\centering
				\includegraphics[width=1\linewidth]{assets/sequence_diagrams/exports/workflow_public_subject_1.pdf}
				\label{fig:registration_sequence}
			\end{figure}
